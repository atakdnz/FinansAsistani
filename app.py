...
def run_fuzzy():
    ...
    # ── Mamdani Kural Tabanı (min t-norm, max aggregation, centroid) ─────
    # Kural tasarımı:
    # - Tek değişkenli kural kullanmayarak bir girdinin sistemi domine etmesini engeller.
    # - Risk veya vade çoğu kuralda yer alır, böylece kullanıcı tercihi korunur.
    # - Çelişen sinyaller Dengeli profile çekilir.
    # - Agresif profil yalnızca risk, vade ve finansal sağlık birlikte uygunsa oluşur.
    kurallar = [
        # Güvenilir: düşük risk tercihi veya belirgin mali kırılganlık.
        (min(deg_risk["Düşük"], deg_vade["Kısa"]), "Güvenilir",
         "K1", "Risk=Düşük & Vade=Kısa", "Güvenilir"),
        (min(deg_risk["Düşük"], deg_vade["Orta"]), "Güvenilir",
         "K2", "Risk=Düşük & Vade=Orta", "Güvenilir"),
        (min(deg_risk["Düşük"], deg_tampon["Zayıf"]), "Güvenilir",
         "K3", "Risk=Düşük & Tampon=Zayıf", "Güvenilir"),
        (min(deg_risk["Düşük"], deg_borc["Yüksek"]), "Güvenilir",
         "K4", "Risk=Düşük & Borç=Yüksek", "Güvenilir"),
        (min(deg_tampon["Zayıf"], deg_borc["Yüksek"]), "Güvenilir",
         "K5", "Tampon=Zayıf & Borç=Yüksek", "Güvenilir"),
        (min(deg_borc["Yüksek"], deg_esn["Düşük"]), "Güvenilir",
         "K6", "Borç=Yüksek & Esn=Düşük", "Güvenilir"),
        (min(deg_tampon["Zayıf"], deg_esn["Düşük"], deg_duz["Düzensiz"]), "Güvenilir",
         "K7", "Tampon=Zayıf & Esn=Düşük & Gel=Düzensiz", "Güvenilir"),
        (min(deg_risk["Orta"], deg_tampon["Zayıf"], deg_borc["Yüksek"]), "Güvenilir",
         "K8", "Risk=Orta & Tampon=Zayıf & Borç=Yüksek", "Güvenilir"),
        (min(deg_risk["Orta"], deg_vade["Kısa"]), "Güvenilir",
         "K9", "Risk=Orta & Vade=Kısa", "Güvenilir"),

        # Dengeli: orta yol veya çelişen finansal/kullanıcı sinyalleri.
        (min(deg_risk["Orta"], deg_vade["Orta"]), "Dengeli",
         "K10", "Risk=Orta & Vade=Orta", "Dengeli"),
        (min(deg_risk["Orta"], deg_vade["Uzun"], deg_borc["Düşük"]), "Dengeli",
         "K11", "Risk=Orta & Vade=Uzun & Borç=Düşük", "Dengeli"),
        (min(deg_risk["Orta"], deg_tampon["Güçlü"], deg_esn["Yüksek"]), "Dengeli",
         "K12", "Risk=Orta & Tampon=Güçlü & Esn=Yüksek", "Dengeli"),
        (min(deg_risk["Orta"], deg_tampon["Orta"], deg_duz["Düzenli"]), "Dengeli",
         "K13", "Risk=Orta & Tampon=Orta & Gel=Düzenli", "Dengeli"),
        (min(deg_risk["Yüksek"], deg_vade["Kısa"]), "Dengeli",
         "K14", "Risk=Yüksek & Vade=Kısa", "Dengeli"),
        (min(deg_risk["Yüksek"], deg_tampon["Zayıf"]), "Dengeli",
         "K15", "Risk=Yüksek & Tampon=Zayıf", "Dengeli"),
        (min(deg_risk["Yüksek"], deg_borc["Orta"]), "Dengeli",
         "K16", "Risk=Yüksek & Borç=Orta", "Dengeli"),
        (min(deg_risk["Yüksek"], deg_vade["Orta"], deg_tampon["Güçlü"]), "Dengeli",
         "K17", "Risk=Yüksek & Vade=Orta & Tampon=Güçlü", "Dengeli"),
        (min(deg_risk["Düşük"], deg_tampon["Güçlü"], deg_vade["Uzun"], deg_borc["Düşük"]), "Dengeli",
         "K18", "Risk=Düşük & Tampon=Güçlü & Vade=Uzun & Borç=Düşük", "Dengeli"),
        (min(deg_esn["Yüksek"], deg_duz["Düzenli"], deg_vade["Uzun"], deg_risk["Orta"]), "Dengeli",
         "K19", "Esn=Yüksek & Gel=Düzenli & Vade=Uzun & Risk=Orta", "Dengeli"),

        # Agresif: yalnızca risk, vade ve finansal sağlık birlikte uygunsa.
        (min(deg_risk["Yüksek"], deg_vade["Uzun"], deg_tampon["Güçlü"], deg_borc["Düşük"]), "Agresif",
         "K20", "Risk=Yüksek & Vade=Uzun & Tampon=Güçlü & Borç=Düşük", "Agresif"),
        (min(deg_risk["Yüksek"], deg_vade["Uzun"], deg_esn["Yüksek"], deg_duz["Düzenli"]), "Agresif",
         "K21", "Risk=Yüksek & Vade=Uzun & Esn=Yüksek & Gel=Düzenli", "Agresif"),
        (min(deg_risk["Yüksek"], deg_vade["Uzun"], deg_tampon["Güçlü"], deg_esn["Yüksek"]), "Agresif",
         "K22", "Risk=Yüksek & Vade=Uzun & Tampon=Güçlü & Esn=Yüksek", "Agresif"),
        (min(deg_risk["Yüksek"], deg_vade["Uzun"], deg_duz["Düzenli"], deg_borc["Düşük"]), "Agresif",
         "K23", "Risk=Yüksek & Vade=Uzun & Gel=Düzenli & Borç=Düşük", "Agresif"),
        (min(deg_risk["Yüksek"], deg_vade["Orta"], deg_tampon["Güçlü"], deg_esn["Yüksek"], deg_borc["Düşük"]), "Agresif",
         "K24", "Risk=Yüksek & Vade=Orta & Tampon=Güçlü & Esn=Yüksek & Borç=Düşük", "Agresif"),
        (min(deg_risk["Yüksek"], deg_esn["Yüksek"], deg_tampon["Güçlü"], deg_borc["Düşük"], deg_duz["Düzenli"]), "Agresif",
         "K25", "Risk=Yüksek & Esn=Yüksek & Tampon=Güçlü & Borç=Düşük & Gel=Düzenli", "Agresif"),
    ]
